...
public class PopupView extends PopupWindow {
    ...
    public void showAtTop(View anchor, Point origin, int xOff, int yOff) {
        Log.d(TAG, "showAtTop() called with: anchor = [" + anchor + "], origin = [" + origin + "], xOff = [" + xOff + "], yOff = [" + yOff + "]");
        showAsDropDown(anchor, xOff, yOff);
    }

    public void showAtLeft(View anchor, Point origin, int xOff, int yOff) {
        Log.d(TAG, "showAtLeft() called with: anchor = [" + anchor + "], origin = [" + origin + "], xOff = [" + xOff + "], yOff = [" + yOff + "]");
        showAsDropDown(anchor, xOff, yOff);
    }

    public void showAtRight(View anchor, Point origin, int xOff, int yOff) {
        Log.d(TAG, "showAtRight() called with: anchor = [" + anchor + "], origin = [" + origin + "], xOff = [" + xOff + "], yOff = [" + yOff + "]");
        showAsDropDown(anchor, xOff, yOff);
    }

    public void showAtBottom(View anchor, Point origin, int xOff, int yOff) {
        Log.d(TAG, "showAtBottom() called with: anchor = [" + anchor + "], origin = [" + origin + "], xOff = [" + xOff + "], yOff = [" + yOff + "]");
        showAsDropDown(anchor, xOff, yOff);
    }
